...
SET @cmd="CREATE TABLE IF NOT EXISTS replica_relay_log_info (
  ...
  Primary_log_pos BIGINT UNSIGNED NOT NULL COMMENT 'The primary log position of the last executed event.', 
  Sql_delay INTEGER NOT NULL COMMENT 'The number of seconds that the replica must lag behind the primary.', 
  ...
  Channel_name CHAR(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'The channel on which the replica is connected to a source. Used in Multisource Replication',
...
SET @cmd= "CREATE TABLE IF NOT EXISTS replica_primary_info (
  ...
  Primary_log_pos BIGINT UNSIGNED NOT NULL COMMENT 'The primary log position of the last read event.', 
  Host CHAR(64) CHARACTER SET utf8 COLLATE utf8_bin COMMENT 'The host name of the primary.', 
  ...
  Port INTEGER UNSIGNED NOT NULL COMMENT 'The network port used to connect to the primary.', 
  Connect_retry INTEGER UNSIGNED NOT NULL COMMENT 'The period (in seconds) that the replica will wait before trying to reconnect to the primary.', 
  ...
  Retry_count BIGINT UNSIGNED NOT NULL COMMENT 'Number of reconnect attempts, to the primary, before giving up.', 
  Ssl_crl TEXT CHARACTER SET utf8 COLLATE utf8_bin COMMENT 'The file used for the Certificate Revocation List (CRL)', 
  Ssl_crlpath TEXT CHARACTER SET utf8 COLLATE utf8_bin COMMENT 'The path used for Certificate Revocation List (CRL) files', 
  Enabled_auto_position BOOLEAN NOT NULL COMMENT 'Indicates whether GTIDs will be used to retrieve events from the primary.',
  Channel_name CHAR(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'The channel on which the replica is connected to a source. Used in Multisource Replication',
  PRIMARY KEY(Channel_name)) DEFAULT CHARSET=utf8 STATS_PERSISTENT=0 COMMENT 'Primary Information'";
