...
ALTER TABLE `replica_primary_info` ENGINE=MyISAM STATS_PERSISTENT=DEFAULT;
ALTER TABLE `replica_relay_log_info` ENGINE=MyISAM STATS_PERSISTENT=DEFAULT;
ALTER TABLE `replica_worker_info` ENGINE=MyISAM STATS_PERSISTENT=DEFAULT;
