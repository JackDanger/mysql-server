...
static const SYMBOL symbols[] = {
  ...
  */
  ...
  { SYM("PRIMARY_NODE",             PRIMARY_NODE_SYM)},
  { SYM("PRIMARY_AUTO_POSITION",    PRIMARY_AUTO_POSITION_SYM)},
  { SYM("PRIMARY_BIND",             PRIMARY_BIND_SYM)},
  { SYM("PRIMARY_CONNECT_RETRY",    PRIMARY_CONNECT_RETRY_SYM)},
  { SYM("PRIMARY_DELAY",            PRIMARY_DELAY_SYM)},
  { SYM("PRIMARY_HOST",             PRIMARY_HOST_SYM)},
  { SYM("PRIMARY_LOG_FILE",         PRIMARY_LOG_FILE_SYM)},
  { SYM("PRIMARY_LOG_POS",          PRIMARY_LOG_POS_SYM)},
  { SYM("PRIMARY_PASSWORD",         PRIMARY_PASSWORD_SYM)},
  { SYM("PRIMARY_PORT",             PRIMARY_PORT_SYM)},
  { SYM("PRIMARY_RETRY_COUNT",      PRIMARY_RETRY_COUNT_SYM)},
  { SYM("PRIMARY_SERVER_ID",        PRIMARY_SERVER_ID_SYM)},
  { SYM("PRIMARY_SSL",              PRIMARY_SSL_SYM)},
  { SYM("PRIMARY_SSL_CA",           PRIMARY_SSL_CA_SYM)},
  { SYM("PRIMARY_SSL_CAPATH",       PRIMARY_SSL_CAPATH_SYM)},
  { SYM("PRIMARY_SSL_CERT",         PRIMARY_SSL_CERT_SYM)},
  { SYM("PRIMARY_SSL_CIPHER",       PRIMARY_SSL_CIPHER_SYM)},
  { SYM("PRIMARY_SSL_CRL",          PRIMARY_SSL_CRL_SYM)},
  { SYM("PRIMARY_SSL_CRLPATH",      PRIMARY_SSL_CRLPATH_SYM)},
  { SYM("PRIMARY_SSL_KEY",          PRIMARY_SSL_KEY_SYM)},
  { SYM("PRIMARY_SSL_VERIFY_SERVER_CERT", PRIMARY_SSL_VERIFY_SERVER_CERT_SYM)},
  { SYM("PRIMARY_USER",             PRIMARY_USER_SYM)},
  { SYM("PRIMARY_HEARTBEAT_PERIOD", PRIMARY_HEARTBEAT_PERIOD_SYM)},
  { SYM("MATCH",                    MATCH)},
