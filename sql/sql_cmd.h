...
enum enum_sql_command {
  ...
  SQLCOM_SHOW_PROCESSLIST, SQLCOM_SHOW_PRIMARY_STAT, SQLCOM_SHOW_REPLICA_STAT,
  ...
  SQLCOM_REPLICA_START, SQLCOM_REPLICA_STOP,
  SQLCOM_START_GROUP_REPLICATION, SQLCOM_STOP_GROUP_REPLICATION,
  SQLCOM_BEGIN, SQLCOM_CHANGE_PRIMARY, SQLCOM_CHANGE_REPLICATION_FILTER,
  SQLCOM_RENAME_TABLE,  
  SQLCOM_RESET, SQLCOM_PURGE, SQLCOM_PURGE_BEFORE, SQLCOM_SHOW_BINLOGS,
  SQLCOM_SHOW_OPEN_TABLES,
  SQLCOM_HA_OPEN, SQLCOM_HA_CLOSE, SQLCOM_HA_READ,
  SQLCOM_SHOW_REPLICA_HOSTS, SQLCOM_DELETE_MULTI, SQLCOM_UPDATE_MULTI,
