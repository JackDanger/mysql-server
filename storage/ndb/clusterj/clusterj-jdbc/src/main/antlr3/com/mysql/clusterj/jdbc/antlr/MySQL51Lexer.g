...
PRIMARY_SSL_VERIFY_SERVER_CERT	:	'PRIMARY_SSL_VERIFY_SERVER_CERT';
MATCH	:	'MATCH';
...
PRIMARY_CONNECT_RETRY	:	'PRIMARY_CONNECT_RETRY'; 
PRIMARY_SSL	:	'PRIMARY_SSL';           
PRIMARY_SSL_CA	:	'PRIMARY_SSL_CA';        
PRIMARY_SSL_CAPATH	:	'PRIMARY_SSL_CAPATH';    
PRIMARY_SSL_CERT	:	'PRIMARY_SSL_CERT';      
PRIMARY_SSL_CIPHER	:	'PRIMARY_SSL_CIPHER';    
