...
ident_sp_label
	...
	|	tok=PRIMARY_HOST!
	|	tok=PRIMARY_PORT!
	|	tok=PRIMARY_LOG_FILE!
	|	tok=PRIMARY_LOG_POS!
	|	tok=PRIMARY_USER!
	|	tok=PRIMARY_PASSWORD!
	|	tok=PRIMARY_SERVER_ID!
	|	tok=PRIMARY_CONNECT_RETRY!
	|	tok=PRIMARY_SSL!
	|	tok=PRIMARY_SSL_CA!
	|	tok=PRIMARY_SSL_CAPATH!
	|	tok=PRIMARY_SSL_CERT!
	|	tok=PRIMARY_SSL_CIPHER!
	|	tok=PRIMARY_SSL_KEY!
