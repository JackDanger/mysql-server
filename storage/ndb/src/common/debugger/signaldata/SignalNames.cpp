...
const GsnName SignalNames [] = {
  ...
  ,{ GSN_PRIMARY_GCPCONF,         "PRIMARY_GCPCONF" }
  ,{ GSN_PRIMARY_GCPREF,          "PRIMARY_GCPREF" }
  ,{ GSN_PRIMARY_GCPREQ,          "PRIMARY_GCPREQ" }
  ,{ GSN_PRIMARY_LCPCONF,         "PRIMARY_LCPCONF" }
  ,{ GSN_PRIMARY_LCPREF,          "PRIMARY_LCPREF" }
  ,{ GSN_PRIMARY_LCPREQ,          "PRIMARY_LCPREQ" }
