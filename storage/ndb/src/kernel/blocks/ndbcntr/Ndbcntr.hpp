...
private:
   ...
   *
   * WHEN THE SYSTEM IS RUNNING THE PRIMARY WILL CHECK IF ANY NODE HAS MADE 
   * A CNTR_PRIMARYREQ AND TAKE CARE OF THE REQUEST. 
   * TO CONFIRM THE REQ, THE PRIMARY DEMANDS THAT ALL RUNNING NODES HAS VOTED 
   * FOR THE NEW NODE. 
   * NODE_PTR:PRIMARY_REQ IS USED DURING RESTART TO LOG 
   * POSTPONED CNTR_PRIMARYREQ'S 
   *------------------------------------------------------------------------*/
