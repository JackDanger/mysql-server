...
{ { "restart_info", 22, 0,
       "Times of restart phases in seconds and current state" },
  {
    ...
    {"secs_until_wait_for_ndbcntr_primary",                     Ndbinfo::Number,
     "Seconds from included in HB protocol until we wait for ndbcntr primary"},
    {"secs_wait_for_ndbcntr_primary",                        Ndbinfo::Number,
     "Seconds we waited for being accepted by NDBCNTR primary to start" },
    {"secs_to_get_start_permitted",                         Ndbinfo::Number,
     "Seconds from permit by primary until all nodes accepted our start" },
    ...
    {"secs_to_copy_meta_data",                              Ndbinfo::Number,
     "Seconds to copy meta data to starting node from primary" },
